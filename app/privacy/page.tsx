...
import { ArrowLeft, Shield, Eye, Lock, Database, Terminal, FileText, ChevronRight } from "lucide-react";
          ...
          <div className="space-y-8">
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex items-center gap-3 px-4 py-2 bg-indigo-500/10 border border-indigo-500/20 rounded-full text-indigo-400">
                 <Shield size={12} />
                 <span className="text-[9px] font-black uppercase tracking-[0.3em]">Protected</span>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-24">
          ...
          >
             <div className="p-10 bg-[#080808] border border-white/10 rounded-[3rem] space-y-6 relative overflow-hidden group">
                ...
                <Lock size={32} className="text-indigo-500/40 group-hover:scale-110 transition-transform duration-700" />
                <h3 className="text-xl font-black italic uppercase tracking-tighter text-white">Zero Leakage</h3>
                <p className="text-[11px] text-white/40 font-bold leading-relaxed italic uppercase tracking-widest">"Your strategies are yours. We do not sell your trading data to third-party liquidity providers or hedge funds."</p>
             </div>

             <div className="p-10 bg-[#080808] border border-white/10 rounded-[3rem] space-y-6 relative overflow-hidden group">
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/[0.03] to-transparent pointer-events-none" />
                <Database size={32} className="text-emerald-500/40 group-hover:scale-110 transition-transform duration-700" />
                <h3 className="text-xl font-black italic uppercase tracking-tighter text-white">Your Data</h3>
                <p className="text-[11px] text-white/40 font-bold leading-relaxed italic uppercase tracking-widest">"You can export or delete your data at any time through your dashboard settings."</p>
             </div>
          </motion.div>
            ...
            {[
              {
                ...
                content: "We only collect the data needed to help you track your trading. This includes your trade logs, notes, and the strategies you build."
              },
              {
                id: "02",
                title: "How We Use Data",
                content: "Your data is used to generate insights and statistics. All processing is private to your account and secured with standard encryption."
              },
              {
                id: "03",
                title: "Security",
                content: "We use secure login protocols and monitor for any unusual activity to keep your trading journal safe and private.",
                highlight: true
              }
            ].map((section, i) => (
              <section key={i} className="space-y-10 group">
                ...
                {section.highlight ? (
                  <div className="p-12 bg-indigo-500/5 border border-indigo-500/10 rounded-[3rem] space-y-6 relative overflow-hidden">
                     <div className="flex items-center gap-4">
                        <Eye size={20} className="text-indigo-400" />
                        <span className="text-xs font-black uppercase tracking-[0.4em] text-indigo-400">Security Protocol Alpha</span>
                     </div>
                     <p className="text-white/60 text-xl font-medium leading-relaxed italic uppercase tracking-tighter">
                        {section.content}
                     </p>
                  </div>
                ) : (
            ...
            <div className="pt-20">
               <div className="p-12 border border-white/5 bg-white/[0.01] rounded-[3rem] flex flex-col md:flex-row justify-between items-center gap-10">
                  <div className="space-y-2 text-center md:text-left">
                     <h4 className="text-lg font-black uppercase tracking-widest italic text-white/60">Have Questions?</h4>
                     <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/20">We are here to help you.</p>
                  </div>
